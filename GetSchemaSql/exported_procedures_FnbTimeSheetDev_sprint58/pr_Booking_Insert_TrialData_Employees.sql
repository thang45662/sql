...
BEGIN
    ...
    BEGIN
        ...
        VALUES (@employeeId2, 'NV000002', N'Mailee Sovan', 1, @taikhoan2, @tenantId, @branchId, @userId, GETDATE(), 0, '+1 323-555-0456');
        ...
        INSERT INTO Employee (Id, Code, [Name], IsActive, UserId, TenantId, BranchId, CreatedBy, CreatedDate, IsDeleted, [MobilePhone])
        VALUES (@employeeId3, 'NV000003', N'Chanlina Pheng', 1, NULL, @tenantId, @branchId, @userId, GETDATE(), 0, '+1 626-555-0789');
