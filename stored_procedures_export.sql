...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_TimeSheetShift
-- ================================================
CREATE PROCEDURE [dbo].[pr_Booking_Insert_TrialData_TimeSheetShift]
(
	@shiftId1			VARCHAR(50),
	@shiftId2			VARCHAR(50),
	@timeSheetId1		BIGINT,
...
-- ================================================
-- Procedure: pr_Booking_Insert_SampleData_JobTitles
-- ================================================

CREATE PROCEDURE [dbo].[pr_Booking_Insert_SampleData_JobTitles]
(
...
-- ================================================
-- Procedure: pr_Booking_Insert_Sample_Department
-- ================================================

CREATE PROCEDURE [dbo].[pr_Booking_Insert_Sample_Department]
(
    @tenantId	INT,			-- ID gian hàng
	@userId		BIGINT,			-- ID tài khoản admin
    @language	NVARCHAR(50)	-- ngôn ngữ (en-US/vi-VN)
...
-- ================================================
-- Procedure: pr_Booking_Insert_SampleData
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Allowance
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Clocking
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Deduction
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Employees
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_PayRateTemplate
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Paysheet
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Payslip
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_PayslipClocking
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_Shifts
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Delete_TrialData_TimeSheet
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Allowance
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Clocking
-- ================================================
...
(
	...
	@prevTimeSheetId1	BIGINT,				-- ✅ THÊM: ID lịch làm việc tháng trước ca 1 (tuần đầu tiên nếu là 2.0)
	@prevTimeSheetId2	BIGINT				-- ✅ THÊM: ID lịch làm việc tháng trước ca 2 (tuần đầu tiên nếu là 2.0)
)
AS
BEGIN
	SET NOCOUNT ON;
	PRINT '=== pr_Booking_Insert_TrialData_Clocking START ==='
	...
	PRINT 'Creating Clocking for Current Period: ' + CONVERT(VARCHAR, @clockingStartDate, 103) + ' - ' + CONVERT(VARCHAR, @clockingEndDate, 103)

	-- =====================================================
	-- 1. TẠO CLOCKING CHO THÁNG HIỆN TẠI (GIỮ LOGIC CŨ)
	-- =====================================================
	...
	BEGIN
		...
		IF (@useNewTimeSheet = 0 OR (@useNewTimeSheet = 1 AND @dayCounter % 2 = 1)) -- Logic cũ cho TimeSheet 1.0 hoặc ngày lẻ cho 2.0
		BEGIN
			SET @startDateCaChieu = (SELECT CAST(CONVERT(CHAR(8), @currentLoopDate, 112) + ' 15:00:00' AS datetime))
			SET @endDateCaChieu = (SELECT CAST(CONVERT(CHAR(8), @currentLoopDate, 112) + ' 22:30:00' AS datetime))
			SET @clockingId = NEXT VALUE FOR ClockingSeq
	...
	PRINT 'Finished creating Clocking for Current Period.'
	...
	PRINT 'Creating Clocking for Previous Month: ' + CONVERT(VARCHAR, @prevMonthStartDate, 103) + ' - ' + CONVERT(VARCHAR, @prevMonthEndDate, 103)

	-- Lấy RepeatDaysOfWeek từ TimeSheetShift cho ca 1 và ca 2 (tháng trước)
	-- Giả định rằng TimeSheetShift cho tháng trước đã được tạo và có RepeatDaysOfWeek tương ứng
	...
	BEGIN
		...
		END
	END
	PRINT '=== pr_Booking_Insert_TrialData_Clocking END ==='
END
GO

-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Deduction
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Employees
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_PayRate
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_PayRateDetail
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_PayRateTemplate
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_PayRateTemplateDetail
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Paysheet
-- ================================================
...
-- ================================================
-- Procedure: sp_InsertPayslipDetailsForEmployee
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Payslip
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_PayslipClocking
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_PayslipDetail
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_Shifts
-- ================================================
...
-- ================================================
-- Procedure: pr_Booking_Insert_TrialData_TimeSheet
-- ================================================
...
-- ================================================
-- Procedure: pr_GetNextEmployeeCode
-- ================================================
...
-- ================================================
-- Procedure: pr_Update_Clocking_Time
-- ================================================
...
-- ================================================
-- Procedure: CheckOutOfSyncSequences
-- ================================================
create procedure CheckOutOfSyncSequences (@autoFix bit = 0) as
begin
