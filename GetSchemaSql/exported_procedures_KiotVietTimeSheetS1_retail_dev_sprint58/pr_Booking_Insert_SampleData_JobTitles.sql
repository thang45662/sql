...
BEGIN
    ...
    BEGIN
        ...
        VALUES
            ...
            (NEXT VALUE FOR JobTitleSeq, N'Nhân viên thu ngân','', 1, @tenantId, @userId, GETDATE(), NULL, NULL, 0, NULL, NULL),
            (NEXT VALUE FOR JobTitleSeq, N'Kế toán','', 1, @tenantId, @userId, GETDATE(), NULL, NULL, 0, NULL, NULL),
            (NEXT VALUE FOR JobTitleSeq, N'Nhân viên kho','', 1, @tenantId, @userId, GETDATE(), NULL, NULL, 0, NULL, NULL),
