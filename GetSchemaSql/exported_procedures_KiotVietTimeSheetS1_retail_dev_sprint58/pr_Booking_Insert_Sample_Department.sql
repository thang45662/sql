...
BEGIN
    ...
    BEGIN
        ...
        VALUES
            ...
            (NEXT VALUE FOR DepartmentSeq, N'Bán hàng ','', 1, @tenantId,@userId, GETDATE(), NULL, NULL, 0, NULL, NULL),
            (NEXT VALUE FOR DepartmentSeq, N'Quản lý','', 1, @tenantId,@userId, GETDATE(), NULL, NULL, 0, NULL, NULL),
			(NEXT VALUE FOR DepartmentSeq, N'Kho','', 1, @tenantId,@userId, GETDATE(), NULL, NULL, 0, NULL, NULL)
    END
END
